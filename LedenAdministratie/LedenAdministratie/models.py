...
class Member(models.Model):
    ...
    tshirt = models.CharField(max_length=200, blank=False)
    jubbadge = models.CharField(max_length=200, blank=False)
    verzekering = models.CharField(max_length=200, blank=False)
    ...
    foto_publiek = models.BooleanField(null=False, default=False)
    foto_intern = models.BooleanField(null=False, default=False)
