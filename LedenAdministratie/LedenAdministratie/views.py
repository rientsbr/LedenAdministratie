...
def do_export(request, speltak):
    ...
    writer.writerow(
        ['Voornaam', 'Achternaam', 'SN', 'Geb. Datum', 'Leeftijd', 'Geslacht', 'Speltak', 'E-mail', 'Straat',
         ...
         'E-mail Ouder 1', 'E-mail Ouder 2', 'FotoPubliek',  'FotoIntern','Inschrijf Datum', 'Jub. Badge'])
    ...
    for lid in leden:
        writer.writerow([lid.first_name, lid.last_name, lid.scouting_nr, lid.gebdat, lid.age, lid.geslacht, lid.speltak,
                         ...
                         lid.mobiel, lid.mobiel_ouder1, lid.mobiel_ouder2, lid.email_ouder1, lid.email_ouder2, lid.foto, lid.foto2,
